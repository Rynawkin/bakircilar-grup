  ...
  return (
    <>
      <Header
        logo={
          <div className="flex items-center">
            <div className="w-10 h-10 bg-red-500 rounded-lg flex items-center justify-center text-white font-bold text-xl mr-3 shadow-lg">
              O
            </div>
            <span className="text-xl font-bold text-white">Bakırcılar Otomotiv</span>
          </div>
        }
        menuItems={menuItems}
      ...
      <Footer
        logo={
          <div className="flex items-center">
            <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center text-red-500 font-bold text-xl mr-3">
              O
            </div>
            <span className="text-xl font-bold text-white">Bakırcılar Otomotiv</span>
          </div>
        ...
        companyName="Bakırcılar Otomotiv"
        email="info@bakircilaroto.com"
