...
export default function AboutPage() {
  ...
  const values = [
    { key: 'innovation', icon: '💡', color: 'from-red-500 to-rose-500' },
  ...
  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <section className="relative py-20 bg-gradient-to-br from-red-600 via-red-700 to-rose-800 text-white overflow-hidden">
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <motion.div
              ...
              className="group"
            >
              <Card className="h-full p-10 relative overflow-hidden border-2 border-transparent hover:border-red-300 transition-all">
                <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-red-500 to-rose-500" />

                <div className="relative inline-flex mb-6">
                  <div className="absolute inset-0 bg-red-500 opacity-20 rounded-full blur-2xl" />
                  <div className="relative text-6xl p-6 bg-red-50 rounded-2xl">
                    🎯
                  </div>
                </div>

                <h3 className="text-3xl font-bold mb-6 text-red-600">{t('about.vision.title')}</h3>
            ...
            >
              <Card className="h-full p-10 relative overflow-hidden border-2 border-transparent hover:border-red-300 transition-all">
                ...
                <h3 className="text-3xl font-bold mb-6 text-red-600">{t('about.mission.title')}</h3>
                <p className="text-gray-700 text-lg leading-relaxed">
      ...
      <section className="py-24 bg-gradient-to-br from-red-600 via-red-700 to-rose-800 text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-72 h-72 bg-red-400 rounded-full blur-3xl animate-pulse" />
        ...
        <Container className="relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {[
              { value: '5', label: t('stats.companies'), gradient: 'from-red-400 to-rose-400', icon: '📦' },
              ...
              >
                <div className="text-center p-8 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl">
                  ...
                  <div className="text-base md:text-lg text-red-100 font-semibold">
                    {stat.label}
                  </div>
                </div>
              </motion.div>
