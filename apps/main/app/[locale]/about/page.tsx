...
export default function AboutPage() {
  ...
  const values = [
    { key: 'innovation', icon: '💡', color: 'from-blue-500 to-cyan-500' },
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <motion.div
              ...
              className="group"
            >
              <Card className="h-full p-10 relative overflow-hidden border-2 border-transparent hover:border-blue-300 transition-all">
                <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-blue-500 to-cyan-500" />

                <div className="relative inline-flex mb-6">
                  <div className="absolute inset-0 bg-blue-500 opacity-20 rounded-full blur-2xl" />
                  <div className="relative text-6xl p-6 bg-blue-50 rounded-2xl">
                    🎯
                  </div>
                </div>

                <h3 className="text-3xl font-bold mb-6 text-blue-600">{t('about.vision.title')}</h3>
