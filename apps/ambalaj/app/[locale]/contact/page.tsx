        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <Card className="p-8 md:p-10 border-2 border-gray-100 hover:border-blue-200 transition-all hover:shadow-2xl">
                <ContactForm
              ...
              <Card className="p-8 border-2 border-transparent hover:border-blue-200 transition-all hover:shadow-2xl relative overflow-hidden group">
                ...
                <div className="flex items-center gap-3 mb-6">
                  <div className="relative inline-flex">
                    <div className="absolute inset-0 bg-blue-500 opacity-20 rounded-xl blur-xl" />
                    <div className="relative bg-blue-500 text-white p-3 rounded-xl group-hover:scale-110 transition-transform">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                    ...
                    <span className="text-blue-600 font-semibold">09:00 - 18:00</span>
                  </div>
