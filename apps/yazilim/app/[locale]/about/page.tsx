...
export default function AboutPage() {
  ...
  const values = [
    ...
    { key: 'reliability', icon: '🤝', color: 'from-blue-500 to-cyan-500' },
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              className="group"
            >
              <Card className="h-full p-10 relative overflow-hidden border-2 border-transparent hover:border-pink-300 transition-all">
                <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-pink-500 to-purple-500" />

                <div className="relative inline-flex mb-6">
                  <div className="absolute inset-0 bg-pink-500 opacity-20 rounded-full blur-2xl" />
                  <div className="relative text-6xl p-6 bg-pink-50 rounded-2xl">
                    🚀
                  </div>
                </div>

                <h3 className="text-3xl font-bold mb-6 text-pink-600">{t('about.mission.title')}</h3>
                <p className="text-gray-700 text-lg leading-relaxed">
      ...
      <section className="py-24 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white relative overflow-hidden">
        ...
        <Container className="relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {[
              { value: '4', label: t('stats.companies'), gradient: 'from-purple-400 to-pink-400', icon: '💻' },
              { value: '50+', label: t('stats.employees'), gradient: 'from-blue-400 to-cyan-400', icon: '👥' },
              { value: '15+', label: t('stats.experience'), gradient: 'from-green-400 to-emerald-400', icon: '📅' },
              { value: '500+', label: t('stats.customers'), gradient: 'from-orange-400 to-red-400', icon: '🤝' }
            ].map((stat, index) => (
              <motion.div
                key={index}
