    ...
    <main className="min-h-screen">
      ...
      <section className="relative py-24 bg-gradient-to-br from-green-600 via-green-700 to-emerald-800 text-white overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-20 w-96 h-96 bg-green-400 rounded-full blur-3xl animate-pulse" />
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-emerald-300 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        </div>
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <Card className="p-8 md:p-10 border-2 border-gray-100 hover:border-green-200 transition-all hover:shadow-2xl">
                <ContactForm
            ...
            >
              {/* Map Placeholder */}
              <Card className="h-96 overflow-hidden border-2 border-gray-100 hover:border-green-200 transition-all">
                <div className="w-full h-full bg-gradient-to-br from-green-50 via-green-100 to-emerald-100 flex items-center justify-center relative group">
                  <div className="absolute inset-0 opacity-10">
                    <div className="absolute inset-0" style={{
                      backgroundImage: 'radial-gradient(circle at 20px 20px, rgba(34, 197, 94, 0.5) 2px, transparent 0)',
                      backgroundSize: '50px 50px'
                    }} />
                  </div>
                  <div className="relative text-center p-8">
                    <div className="inline-block mb-4 relative">
                      <div className="absolute inset-0 bg-green-500 opacity-20 rounded-full blur-2xl animate-pulse" />
                    ...
                    <p className="text-green-700 font-bold text-lg">{t('contactPage.mapPlaceholder')}</p>
                    <p className="text-green-600 text-sm mt-2">Google Maps entegrasyonu</p>
                  </div>
                </div>
              </Card>

              {/* Working Hours */}
              <Card className="p-8 border-2 border-transparent hover:border-green-200 transition-all hover:shadow-2xl relative overflow-hidden group">
                <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-green-500 to-emerald-500" />

                <div className="flex items-center gap-3 mb-6">
                  <div className="relative inline-flex">
                    <div className="absolute inset-0 bg-green-500 opacity-20 rounded-xl blur-xl" />
                    <div className="relative bg-green-500 text-white p-3 rounded-xl group-hover:scale-110 transition-transform">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                    ...
                    <span className="text-green-600 font-semibold">09:00 - 18:00</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
